                    ...
                    <div class="exercise-item exercise-type-{{ strtolower($exercise['code']) }}">
                        ...
                        <div class="exercise-info">
                            <div class="exercise-header">
                                @php
                                    $routeName = str_starts_with($exercise['code'], 'W') ? 'embed.writing' : 'embed.speaking';
                                @endphp
                                <a href="{{ route($routeName, ['exercise' => $exercise['id'], 'questionId' => $exercise['first_question_id']]) }}" class="exercise-title">
                                    {{ $exercise['title'] }}
                                </a>
