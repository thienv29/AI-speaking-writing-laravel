...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-6">
        ...
        <p class="mt-2 text-gray-600">Thêm câu hỏi mới vào hệ thống</p>
    </div>
        ...
        <form action="{{ route('admin.questions.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="prompt_text" name="prompt_text" rows="3" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('prompt_text') }}</textarea>
            </div>

            <div class="mb-4">
                <label for="target_text" class="block text-sm font-medium text-gray-700 mb-2">Đáp án (cho speaking)</label>
                <input type="text" id="target_text" name="target_text" value="{{ old('target_text') }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="starter_text" name="starter_text" value="{{ old('starter_text') }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                    placeholder="VD: I am...">
            </div>
